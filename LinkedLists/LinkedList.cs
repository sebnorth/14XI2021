...
namespace LinkedLists
{
    ...
    abstract class LinkedList<T>
    {
        ...
        public void LinkedListPrint() {
            ...
            Console.WriteLine("INFORMACJA O LIŚCIE");
            if (head == null)
            {
                ...
                while (wezel!=null)
                {
                    Console.WriteLine("Węzeł: {0}", wezel.Value);
                    // wypisz wezel.Next.Value o ile istnieje: 
                    if (wezel.Next == null)
                    {
                        Console.WriteLine("Wezel, następnik: NULL");
                    }
                    else {

                        Console.WriteLine("Wezel, następnik: {0}", wezel.Next.Value);
                    }

                    // wypisz wezel.Previous.Value o ile istnieje: 
                    if (wezel.Previous == null)
                    {
                        Console.WriteLine("Wezel, poprzednik: NULL");
                    }
                    else
                    {

                        Console.WriteLine("Wezel, poprzednik: {0}", wezel.Previous.Value);
                    }
